...
?>
   	<form action="cart.php" method="post">
	   	...
	   	<a href="index.php" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span>&nbsp; cancel</a>


	</form>
	<br/><br/>
	<a href="checkout.php" class="btn btn-default"><span class="glyphicon glyphicon-ok"></span>&nbsp;Go To Checkout</a> 
	<a href="books.php" class="btn btn-default"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Continue Shopping</a>
<?php
	} else {
